/* Stripe-style WebGL mesh gradient. Vendored from npm "stripe-gradient@1.0.1" (MIT).
   Reverse-engineered Stripe.com gradient; all credit to Stripe. Wrapped as a classic
   script exposing window.Gradient so the page stays openable from file:// (no build,
   no ESM/CORS). Colors are read from --gradient-color-1..4 on the target canvas. */
var module = { exports: {} };
...
window.Gradient = module.exports.Gradient;
